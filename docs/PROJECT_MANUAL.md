...
- `coaches`：教练主表，保存 UID、昵称、球队、级别、头像、称号、称号颜色和简介
...
- 管理员可为教练创建或重置账号
- 教练登录后可以维护自己的头像、个人称号、简介、密码、荣誉和助教团队
- 教练不能修改称号颜色；称号颜色只允许管理员或具备维护权限的账号设置
...
- 支持 `白色 / 绿色 / 蓝色 / 紫色 / 橙色 / 红色 / 彩虹闪动`
- 颜色应表现为文字颜色或文字渐变，而不是简单外圈或标签背景
- 教练列表和教练详情页都应完整表现称号颜色
