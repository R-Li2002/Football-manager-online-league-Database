...
assert.match(ratingBoard.innerHTML, /基础 1,100 · 1场 · 1胜 0平 0负/);
assert.match(ratingBoard.innerHTML, /ranking-desk is-manager/);
assert.match(code, /kind === 'rankings'[\s\S]*?Math\.max\(1\.5, Math\.min\(2,/);
